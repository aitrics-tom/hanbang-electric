      ...
      <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="space-y-3 mb-8">
          <FeatureItem
            icon="📚"
            title="질문 이력 저장"
            description="모든 문제 풀이가 자동으로 저장됩니다"
          />
          <FeatureItem
            icon="📊"
            title="학습 통계"
            description="카테고리별 정답률과 취약점을 분석합니다"
          />
          <FeatureItem
            icon="🎯"
            title="맞춤 추천"
            description="AI가 학습 패턴을 분석해 추천합니다"
          />
        </div>
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-slate-200 rounded-xl text-slate-700 font-medium hover:bg-slate-50 hover:border-slate-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading ? (
